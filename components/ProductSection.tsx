  ...
  return (
    <section className="py-16">
      <div className="container mx-auto px-4">
        ...
        <div 
          ref={scrollRef}
          className="flex gap-6 overflow-x-auto scrollbar-hide pb-4 md:grid md:grid-cols-3 lg:grid-cols-4 md:gap-5 lg:gap-6 md:overflow-visible"
          style={{ scrollbarWidth: 'none', msOverflowStyle: 'none' }}
        >
          {transformedProducts.map((product) => (
            <div key={product.id} className="flex-none w-64 md:w-full">
